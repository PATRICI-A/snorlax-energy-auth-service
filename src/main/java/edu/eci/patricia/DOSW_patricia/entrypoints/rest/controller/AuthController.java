...
public class AuthController {
    ...
    @Operation(summary = "Forgot password", description = "Sends a 6-digit recovery code to the registered email")
    @ApiResponses({
    ...
    @Operation(summary = "Reset password", description = "Validates recovery code and sets a new password")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Password updated successfully"),
        @ApiResponse(responseCode = "422", description = "Invalid or expired recovery code")
    })
